...
___check_global_state = '''<built-in method check of torch._C._dynamo.guards.GlobalStateGuard object at 0x1321b0950>'''
___check_torch_function_mode_stack = '''<function make_torch_function_mode_stack_guard.<locals>.check_torch_function_mode_stack at 0x133532dd0>'''
...
IsNonOverlappingAndDenseIndicator = '''<function eval_is_non_overlapping_and_dense at 0x113f5d120>'''
...
cast_symbool_to_symint_guardless = '''<function cast_symbool_to_symint_guardless at 0x113f5d2d0>'''
...
___key_to_id = '''<function key_to_id at 0x1148ab9a0>'''
___dict_version = '''<built-in function dict_version>'''
___dict_contains = '''<function _get_closure_vars.<locals>.<lambda> at 0x1327beef0>'''
___tuple_iterator_len = '''<method '__length_hint__' of 'tuple_iterator' objects>'''
___tuple_iterator_getitem = '''<function tuple_iterator_getitem at 0x1148ab520>'''
___get_torch_function_mode_stack_at = '''<function get_torch_function_mode_stack_at at 0x1148c6b00>'''
__math_isnan = '''<built-in function isnan>'''
__numpy_isnan = '''<ufunc 'isnan'>'''
inf = '''inf'''
__load_module = '''<function import_module at 0x100a77910>'''
...
___from_numpy = '''<function from_numpy at 0x114d5c280>'''
___as_tensor = '''<function _as_tensor_fullprec at 0x111e9ca60>'''
...
___check_tensors = '''None'''
___check_tensors_verbose = '''None'''
___check_global_state = '''<built-in method check of torch._C._dynamo.guards.GlobalStateGuard object at 0x131c90050>'''
___check_torch_function_mode_stack = '''<function make_torch_function_mode_stack_guard.<locals>.check_torch_function_mode_stack at 0x133531240>'''
Abs = '''<built-in function abs>'''
Eq = '''<built-in function eq>'''
Ne = '''<built-in function ne>'''
Gt = '''<built-in function gt>'''
...
def __guard_0_for_forward(L, G, **___kwargs_ignored):
    ...
    __guard_hit = __guard_hit and hasattr(L['b'], '_dynamo_dynamic_indices') == False
    __guard_hit = __guard_hit and check_no_aliasing(L['a'], L['b'])
    __guard_hit = __guard_hit and ___check_obj_id(G['torch'], 4322356144)
    __guard_hit = __guard_hit and ___check_obj_id(G['torch'].abs, 4375862608)
    return __guard_hit
