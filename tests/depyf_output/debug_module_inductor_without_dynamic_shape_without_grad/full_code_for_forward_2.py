...
___check_global_state = '''<built-in method check of torch._C._dynamo.guards.GlobalStateGuard object at 0x1193a8910>'''
___check_torch_function_mode_stack = '''<function make_torch_function_mode_stack_guard.<locals>.check_torch_function_mode_stack at 0x11bc36dd0>'''
...
IsNonOverlappingAndDenseIndicator = '''<function eval_is_non_overlapping_and_dense at 0x10d25d120>'''
...
cast_symbool_to_symint_guardless = '''<function cast_symbool_to_symint_guardless at 0x10d25d2d0>'''
...
___key_to_id = '''<function key_to_id at 0x10d4ab9a0>'''
___dict_version = '''<built-in function dict_version>'''
___dict_contains = '''<function _get_closure_vars.<locals>.<lambda> at 0x11adbaef0>'''
___tuple_iterator_len = '''<method '__length_hint__' of 'tuple_iterator' objects>'''
___tuple_iterator_getitem = '''<function tuple_iterator_getitem at 0x10d4ab520>'''
___get_torch_function_mode_stack_at = '''<function get_torch_function_mode_stack_at at 0x10d4c6b00>'''
__math_isnan = '''<built-in function isnan>'''
__numpy_isnan = '''<ufunc 'isnan'>'''
inf = '''inf'''
__load_module = '''<function import_module at 0x102b7f910>'''
...
___from_numpy = '''<function from_numpy at 0x10d958280>'''
___as_tensor = '''<function _as_tensor_fullprec at 0x10a198a60>'''
...
___check_tensors = '''None'''
___check_tensors_verbose = '''None'''
___check_global_state = '''<built-in method check of torch._C._dynamo.guards.GlobalStateGuard object at 0x118e97490>'''
___check_torch_function_mode_stack = '''<function make_torch_function_mode_stack_guard.<locals>.check_torch_function_mode_stack at 0x11bc35240>'''
Abs = '''<built-in function abs>'''
Eq = '''<built-in function eq>'''
Ne = '''<built-in function ne>'''
Gt = '''<built-in function gt>'''
...
def __guard_0_for_forward(L, G, **___kwargs_ignored):
    ...
    __guard_hit = __guard_hit and hasattr(L['b'], '_dynamo_dynamic_indices') == False
    __guard_hit = __guard_hit and check_no_aliasing(L['a'], L['b'])
    __guard_hit = __guard_hit and ___check_obj_id(G['torch'], 4356991920)
    __guard_hit = __guard_hit and ___check_obj_id(G['torch'].abs, 4360494256)
    return __guard_hit
