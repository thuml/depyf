...
class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[10]", primals_2: "f32[10]", sum_1: "f32[]", tangents_1: "f32[10]"):
        ...
        mul_2: "f32[10]" = torch.ops.aten.mul.Tensor(tangents_1, div)
        
         # File: /Users/youkaichao/data/DeepLearning/depyf/tests/test_pytorch/test_pytorch.py:14 in forward, code: b = b * -1 + b.sum()
        mul: "f32[10]" = torch.ops.aten.mul.Tensor(primals_2, -1);  primals_2 = None
        ...
        mul_6: "f32[10]" = torch.ops.aten.mul.Tensor(mul_5, sgn);  mul_5 = sgn = None
