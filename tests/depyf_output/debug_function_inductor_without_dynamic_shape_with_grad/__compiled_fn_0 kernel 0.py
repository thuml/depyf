...
def call(args):
    ...
    cpp_fused_abs_add_div_lt_sum_0(c_void_p(primals_1.data_ptr()), c_void_p(primals_2.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()))
    del buf1
    del primals_2
    return (buf0, buf2, primals_1, buf0, )
