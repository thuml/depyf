                       ...
                       const int64_t ks1)
{
    ...
    {
        for(int64_t x0=static_cast<int64_t>(0LL); x0<static_cast<int64_t>(ks1); x0+=static_cast<int64_t>(4LL))
        {
            {
                if(C10_LIKELY(x0 >= static_cast<int64_t>(0) && x0 < static_cast<int64_t>(4LL*(c10::div_floor_integer(static_cast<int64_t>(ks1), static_cast<int64_t>(4LL))))))
                {
                ...
                if(C10_UNLIKELY(x0 >= static_cast<int64_t>(4LL*(c10::div_floor_integer(static_cast<int64_t>(ks1), static_cast<int64_t>(4LL)))) && x0 < static_cast<int64_t>(ks1)))
                {
...
def call(args):
    ...
    s97 = arg0_1
    s52 = arg2_1
    assert_size_stride(arg1_1, (s97, ), (1, ))
    assert_size_stride(arg3_1, (s52, ), (1, ))
    buf0 = empty_strided_cpu((), (), torch.float32)
    buf2 = empty_strided_cpu((), (), torch.bool)
    buf1 = empty_strided_cpu((s97, ), (1, ), torch.float32)
    cpp_fused_abs_add_div_lt_sum_0(arg3_1, arg1_1, buf0, buf2, buf1, s52, s97)
    del arg1_1
    del arg3_1
    return (buf2, buf1, )
