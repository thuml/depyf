...
___check_global_state = '''<built-in method check of torch._C._dynamo.guards.GlobalStateGuard object at 0x10de90230>'''
___check_torch_function_mode_stack = '''<function make_torch_function_mode_stack_guard.<locals>.check_torch_function_mode_stack at 0x10e0b0f40>'''
IsNonOverlappingAndDenseIndicator = '''<function eval_is_non_overlapping_and_dense at 0x10bc00cc0>'''
cast_symbool_to_symint_guardless = '''<function cast_symbool_to_symint_guardless at 0x10bc00ea0>'''
...
___key_to_id = '''<function key_to_id at 0x10bd6c680>'''
___dict_version = '''<built-in function dict_version>'''
___dict_contains = '''<function _get_closure_vars.<locals>.<lambda> at 0x10e0b09a0>'''
___tuple_iterator_len = '''<method '__length_hint__' of 'tuple_iterator' objects>'''
___normalize_range_iter = '''<function normalize_range_iter at 0x10bd2ff60>'''
___tuple_iterator_getitem = '''<function tuple_iterator_getitem at 0x10bd2fe20>'''
___dataclass_fields = '''<function dataclass_fields at 0x10bd2fec0>'''
___namedtuple_fields = '''<function _get_closure_vars.<locals>.<lambda> at 0x10e0b0a40>'''
___get_torch_function_mode_stack_at = '''<function get_torch_function_mode_stack_at at 0x10bd60220>'''
__math_isnan = '''<built-in function isnan>'''
__numpy_isnan = '''<ufunc 'isnan'>'''
inf = '''inf'''
__load_module = '''<function import_module at 0x102732840>'''
...
___from_numpy = '''<function from_numpy at 0x10c2de340>'''
___as_tensor = '''<function _as_tensor_fullprec at 0x1097b6520>'''
...
# Note: please refer to the graph code in __compiled_fn_1_83d9882c_7b83_4ca2_8daf_de2ac24814c6*.py.
# Captured Graph: Dynamo generated graph (debuggable when using eager backend).
# Joint graph: joint forward+backward graph from aot autograd.
# Forward graph: forward graph from aot autograd (debuggable when using aot_eager backend).
# Backward graph: backward graph from aot autograd (debuggable when using aot_eager backend).
# AFTER XXX: graph processed by inductor (not debuggable).
def __compiled_fn_1_83d9882c_7b83_4ca2_8daf_de2ac24814c6(*args, **kwargs):
    pass
...
def __transformed_code_0_for_f(x):
    ...
    graph_out_0 = __compiled_fn_1_83d9882c_7b83_4ca2_8daf_de2ac24814c6(x)
    []
    __temp_7 = []
    __temp_7.extend([])
    [__temp_7]
