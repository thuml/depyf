...
def guard_1(L):
    return (___guarded_code.valid) \
        ...
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(5134734848))) \
        and (___compile_config_hash() == 'a1c95ead708989805e6dbf09852bbe81') \
